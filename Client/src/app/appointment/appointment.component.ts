...
export class AppointmentComponent implements OnInit {
  ...
  checkisPatient() {
    this.blockchainServices
      ...
      .catch((err: any) => {
        ...
        this.progressMsg = 'Only User can book appointments <br> if you are not registerd please Register';
  ...
  addAppointment(){
    ...
    this.progressMsg = 'Adding Request'
    ...
    this.blockchainServices.addAppointment(data).then((r:any)=>{
      ...
      if(r.status ="succcess"){
        this.progressMsg = 'Request Added successfull'
